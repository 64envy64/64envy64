...
document.addEventListener('DOMContentLoaded', function () {
  ...
  ScrollReveal().reveal('#firstset', { delay: 300, origin: 'left', distance: '10px', duration: 800 });
  ScrollReveal().reveal('#secondset', { delay: 300, origin: 'top', distance: '10px', duration: 800 });
  ScrollReveal().reveal('#thirdset', { delay: 350, origin: 'right', distance: '10px', duration: 800 });
  ScrollReveal().reveal('#fourthset', { delay: 350, origin: 'right', distance: '10px', duration: 800 });
  ScrollReveal().reveal('#fiveset', { delay: 350, origin: 'left', distance: '10px', duration: 800 });
